...
class CalculatorApp(App):
    def build(self):
        ...
        self.solution= TextInput(background_color="black",foreground_color="white",multiline=False,halign="right",font_size=60,readonly=True)
